...
public class GetSearchTourAttractionsListResponseDto extends ResponseDto {
    ...
    private GetSearchTourAttractionsListResponseDto(List<TourAttractionViewEntity> resultSets) {
        super(ResponseCode.SUCCESS, ResponseMessage.SUCCESS);
        this.tourAttractionsListItem = TourAttractionsListItem.getTourAttractionsList(resultSets);
    };

    public static ResponseEntity<GetSearchTourAttractionsListResponseDto> success(List<TourAttractionViewEntity> resultSets) {
